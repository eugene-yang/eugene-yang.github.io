function BibtexParser(){this.pos=0,this.input="",this.entries={},this.strings={JAN:"January",FEB:"February",MAR:"March",APR:"April",MAY:"May",JUN:"June",JUL:"July",AUG:"August",SEP:"September",OCT:"October",NOV:"November",DEC:"December"},this.currentKey="",this.rawCurrentKey="",this.currentEntry="",this.setInput=function(t){this.input=t},this.getEntries=function(){return this.entries},this.getBibTexRaw=function(){return this.bibtexraw},this.errorThrown=function(t){$("#bibtex_errors").html(t)},this.isWhitespace=function(t){return" "==t||"\r"==t||"\t"==t||"\n"==t},this.match=function(t){if(this.skipWhitespace(),this.input.substring(this.pos,this.pos+t.length)!=t)throw"Token mismatch, expected "+t+", found "+this.input.substring(this.pos);this.pos+=t.length,this.skipWhitespace()},this.tryMatch=function(t){return this.skipWhitespace(),this.input.substring(this.pos,this.pos+t.length)==t},this.skipWhitespace=function(){for(;this.isWhitespace(this.input[this.pos]);)this.pos++;if("%"==this.input[this.pos]){for(;"\n"!=this.input[this.pos];)this.pos++;this.skipWhitespace()}},this.value_braces=function(){var t=0;this.match("{");for(var e=this.pos;;){if("}"==this.input[this.pos]&&"\\"!=this.input[this.pos-1]){if(!(t>0)){var i=this.pos;return this.match("}"),this.input.substring(e,i)}t--}else if("{"==this.input[this.pos])t++;else if(this.pos==this.input.length-1)throw"Unterminated value";this.pos++}},this.value_quotes=function(){var t=0;this.match('"');for(var e=this.pos;;){if('"'==this.input[this.pos]&&"\\"!=this.input[this.pos-1]&&0==t){var i=this.pos;return this.match('"'),this.input.substring(e,i)}if("{"==this.input[this.pos])t++;else if("}"==this.input[this.pos])t>0&&t--;else if(this.pos==this.input.length-1)throw"Unterminated value:"+this.input.substring(e);this.pos++}},this.single_value=function(){var t=this.pos;if(this.tryMatch("{"))return this.value_braces();if(this.tryMatch('"'))return this.value_quotes();var e=this.key();if(this.strings[e.toUpperCase()])return this.strings[e];if(e.match("^[0-9]+$"))return e;throw"Value expected:"+this.input.substring(t)},this.value=function(){var t=[];for(t.push(this.single_value());this.tryMatch("#");)this.match("#"),t.push(this.single_value());return t.join("")},this.key=function(){for(var t=this.pos;;){if(this.pos==this.input.length)throw"Runaway key";if(!this.input[this.pos].match("[a-zA-Z0-9_:?\\./'\\+\\-\\*]"))return this.rawCurrentKey=this.input.substring(t,this.pos),this.rawCurrentKey.toUpperCase();this.pos++}},this.key_equals_value=function(){var t=this.key();if(this.tryMatch("="))return this.match("="),[t,this.value()];throw"... = value expected, equals sign missing:"+this.input.substring(this.pos)},this.key_value_list=function(){var t=this.key_equals_value();for(this.entries[this.currentEntry][t[0]]=t[1];this.tryMatch(",")&&(this.match(","),!this.tryMatch("}")&&!this.tryMatch(")"));)t=this.key_equals_value(),this.entries[this.currentEntry][t[0]]=t[1]},this.entry_body=function(t){this.currentEntry=this.key(),this.entries[this.currentEntry]=new Object,this.entries[this.currentEntry].BIBTEXKEY=this.rawCurrentKey,"@INCOLLECTION"==t?this.entries[this.currentEntry].BIBTEXTYPE="book chapter":"@INPROCEEDINGS"==t?this.entries[this.currentEntry].BIBTEXTYPE="conference, workshop":"@ARTICLE"==t?this.entries[this.currentEntry].BIBTEXTYPE="journal":"@TECHREPORT"==t&&(this.entries[this.currentEntry].BIBTEXTYPE="technical report"),this.entries[this.currentEntry].BIBTEXTYPEKEY=t,this.match(","),this.key_value_list()},this.directive=function(){return this.match("@"),"@"+this.key()},this.string=function(){var t=this.key_equals_value();this.strings[t[0].toUpperCase()]=t[1]},this.preamble=function(){this.value()},this.comment=function(){this.pos=this.input.indexOf("}",this.pos)},this.entry=function(t){this.entry_body(t)},this.bibtex=function(){for(var t=0,e=0;this.tryMatch("@");){t=this.pos;var i=this.directive().toUpperCase();this.tryMatch("{")?this.match("{"):this.match("("),"@STRING"==i?this.string():"@PREAMBLE"==i?this.preamble():"@COMMENT"==i?this.comment():this.entry(i),e=this.pos+1,this.tryMatch("}")?this.match("}"):this.match(")"),this.tryMatch(",")&&this.match(","),this.pos=e+this.input.substring(e,this.input.length).indexOf("@"),this.entries[this.currentEntry].BIBTEXRAW=this.input.substring(t,e)}}}function BibtexDisplay(){this.invert=function(t){var e={};for(var i in t)t.hasOwnProperty(i)&&(e[t[i]]=i);return e},this.regExps=[],this.regExps.push(new RegExp("{\\\\\\W*\\w+}")),this.regExps.push(new RegExp("\\\\\\W*{\\w+}")),this.regExps.push(new RegExp("\\\\\\W*\\w+\\s")),this.regExps.push(new RegExp("\\\\\\W*\\w+")),this.regExps.push(new RegExp("\\\\(?![:\\\\])\\W{1}")),this.fixValue=function(t){do{var e=t.match(/^\{(.*?)\}$/g,"$1");e&&(t=t.replace(/^\{(.*?)\}$/g,"$1"))}while(e);if(t.indexOf("\\")>-1)for(var i in this.regExps)do{var s=t.match(this.regExps[i]),r=s?s[0]:"";if(s)if(void 0!==latex_to_unicode[r])t=t.replace(r,latex_to_unicode[r]);else{var n=r.replace(new RegExp("(\\w)"),"{$1}");void 0!==latex_to_unicode[n]?t=t.replace(r,latex_to_unicode[n]):s=""}else s=""}while(s.length);return t=t.replace(/[\{|\}]/g,"")},this.getName=function(t){var e=["","","","",""];switch(t.length){case 1:for(var i=t[0].split(/\ \s?(?![^\{]*\})/),s=0;s<i.length-1;s++){var r=s>0?" ":"";if("{"==i[s][0]){if("\\"!=i[s][1]){e[0]+=r+this.fixValue(i[s]);continue}i[s]=this.fixValue(i[s])}if(i[s][0]!=i[s][0].toUpperCase())break;e[0]+=r+this.fixValue(i[s])}for(var n=s,a=s;a<i.length-1;a++)i[a][0]==i[a][0].toLowerCase()&&(n=a);for(;s<=n&&s<i.length-1;s++){r=""!=e[2]?" ":"";e[2]+=r+this.fixValue(i[s])}for(;s<i.length;s++){r=""!=e[3]?" ":"";e[3]+=r+this.fixValue(i[s])}break;case 2:case 3:var h=0;for(i=t[h].split(/\ \s?(?![^\{]*\})/),n=-1,a=s=0;a<i.length-1;a++)i[a][0]==i[a][0].toLowerCase()&&(n=a);for(;s<=n&&s<i.length-1;s++){r=""!=e[2]?" ":"";e[2]+=r+this.fixValue(i[s])}for(;s<i.length;s++){r=""!=e[3]?" ":"";e[3]+=r+this.fixValue(i[s])}h++,3==t.length&&(e[1]=this.fixValue(t[h]),h++),e[0]=this.fixValue(t[h]);break;default:return console.log("Processed author incorrectly!"),e}return""!=e[0]&&(e[4]=e[0].split(" ").map(t=>t.substring(0,1).toUpperCase()).join(". ")+"."),e};var t=Object.freeze({FIRST:0,JUNIOR:1,VON:2,LAST:3,FIRST_INITIAL:4});this.displayAuthor=function(e,s){var r=(e=(e=e.replace(/[ ]*[\n\t][ ]*/g," ")).replace(/[ ]+/g," ")).split(new RegExp(/\s+and\s+?(?![^\{]*\})/)),n=r.length;s.attr("max")&&(n=Math.min(s.attr("max"),n));var a="";if(s.find("span:not(a)").length)for(i=0;i<n;i++){var h=this.getName(r[i].split(/\,\s?(?![^\{]*\})/)),o=s.clone(),l=$.grep(h.slice(0,4),Boolean).join(" ");o.attr("class",l),o.find("span:not(a)").each(function(){var e=t[$(this).attr("class").toUpperCase()];""!=h[e]?$(this).html($(this).html()+h[e]):$(this).remove()}),0==i?a+=o[0].outerHTML:i+1>=r.length?a+=", and "+o[0].outerHTML:a+=", "+o[0].outerHTML}else for(a=r[0],i=1;i<n;i++)i+1>=r.length?a+=", and "+r[i]:a+=", "+r[i];return n!=r.length&&(n>1&&(a+=","),a+=" et al."),a},this.createTemplate=function(t,e){if(e[0].hasAttribute("bibtexkeys")){var i=e[0].getAttribute("bibtexkeys");if(!t.BIBTEXKEY.match(i))return null}var s=$(".bibtex_template").clone().removeClass("bibtex_template"),r=[];for(var n in t)r.push(n.toUpperCase());for(var a=new RegExp("\\s*[\\|\\|]\\s*","gi"),h=new RegExp("\\s*==\\s*","gi");;){var o=s.find(".if");if(0==o.length)break;var l=o.first();l.removeClass("if");var p=!1,c=l.attr("class").split(a),u=this;$.each(c,function(e,i){var s=i.split(h);2==s.length?r.indexOf(s[0].toUpperCase())>0&&u.fixValue(t[s[0].toUpperCase()])==s[1]&&(p|=!0):"!"==i[0]&&r.indexOf(i.substring(1,i.length).toUpperCase())<0?p|=!0:r.indexOf(i.toUpperCase())>0&&(p|=!0),l.removeClass(i)}),p||l.remove()}for(var f in s.find(".bibtexVar").each(function(){var e=$(this).attr("extra").toUpperCase(),i=new RegExp("\\+"+e+"\\+","gi");$.each(this.attributes,function(s,r){var n=r.value;n=n.replace(i,t[e]),r.value=n})}),r){n=r[f];var d=t[n]||"";if("BIBTEXRAW"!=n){if("AUTHOR"==n){var g=s.find("span:not(a)."+n.toLowerCase());d=this.displayAuthor(d,g)}else"PAGES"==n?d=d.replace("--","-"):"DATE"==n?d=moment(d).format("MMM. YYYY"):"URL"==n?(d=d.replace(/\\url/g,""),d=this.fixValue(d)):d=this.fixValue(d);s.find("span:not(a)."+n.toLowerCase()).html(d),s.find("a."+n.toLowerCase()).each(function(){$(this).attr("href")||$(this).attr("href",d)})}else s.find("."+n.toLowerCase()).html(d)}return s.addClass("bibtexentry"),s},this.createArray=function(t){var e=[];for(var i in t)e.push(t[i]);return e},this.sortArray=function(t,e,i,s){var r=e.toUpperCase();return t=t.sort(function(t,e){var n="",a="";switch(n=r in t?t[r]:"",a=r in e?e[r]:"",i.toUpperCase()){case"DESC":break;case"ASC":var h=a;a=n,n=h;break;default:return 0}switch(s.toLowerCase()){case"string":return a.toUpperCase().localeCompare(n.toUpperCase());case"number":return parseInt(a)-parseInt(n);case"date":return new Date(a)-new Date(n);default:return 0}})},this.createStructure=function(t,e,i,s){s=s||0;var r=t.clone().removeClass("bibtex_structure"),n=r.children(".group"),a=r.children(".sections"),h=r.children(".sort");if(n.length){var o=n.first(),l=o.attr("class").split(" ")[1].toUpperCase(),p=o.attr("extra").split(" ")[0],c=o.attr("extra").split(" ")[1],u=this.sortArray(i,l,p,c),f=[];$.each(u,function(t,e){l in e&&-1===$.inArray(e[l],f)&&f.push(e[l])}),f.push("Other Publications");var d=$(".bibtex_topics");for(val in globalStruct=$("<div></div>"),f){var g=r.clone(),v=f[val],b=g.children("."+l.toLowerCase()).first().find(".title");if(b.length?b.prepend(this.fixValue(v)):g.children("."+l.toLowerCase()).first().prepend("<h"+(s+1)+" class='"+l+"' id=\""+v+'">'+this.fixValue(v)+"</h"+(s+1)+">"),splicedArray=$.grep(u,function(t,e){return"Other Publications"==v?void 0===t[l]:t[l]==v}),splicedArray.length){d.length&&0==s&&d.append(' - <a href="#'+v+'"> '+v+" </a>");var y=this.createStructure(n.clone(),e,splicedArray,s+1);n.children(".group").length?(nextGroupName="."+n.children(".group").attr("class").split(" ").join("."),g.find(nextGroupName).replaceWith(y.find(nextGroupName))):g.find(".templates").append(y.find(".templates").html()),0==s?e.append(g):globalStruct.append(g)}}return 0==s?e:globalStruct}if(a.length){f=[];var x=[],m=[],w=a.first().attr("class").split(" ")[1].toUpperCase();$(".section",".sections").each(function(t,e){f.push($(this).attr("class").split(" ")[1].toUpperCase()),x.push($(this))});d=$(".bibtex_topics");globalStruct=$("<div></div>");g=r.clone();for(val in f){var E=f[val],_=new RegExp(E);if(splicedArray=$.grep(i,function(t,e){return _.test(t[w])}),splicedArray.length){if(d.length&&0==s){var C=x[val].children().first().text();d.append(' - <a href="#'+E+'"> '+C+" </a>")}y=this.createStructure(x[val].clone(),e,splicedArray,s+1);n.children(".group").length?(nextGroupName="."+n.children(".group").attr("class").split(" ").join("."),g.find(nextGroupName).replaceWith(y.find(nextGroupName))):g.find(".templates").eq(val).append(y.find(".templates").html()),0==s?e.append(g):globalStruct.append(g)}else m.push(g.find(".section").eq(val))}for(val in m)m[val].remove();return 0==s?e:globalStruct}if(!h.length){for(var S in i){var T=i[S];if(!T.WEB||"NO"!=T.WEB.toUpperCase()){var A=this.createTemplate(T,e);A&&(t.find(".templates").append(A),A.show())}}return t}var B=h.attr("class").split(" ")[1].toUpperCase();p=h.first().attr("extra").split(" ")[0],c=h.first().attr("extra").split(" ")[1],t.children(".sort").first().clone(),u=this.sortArray(i,B,p,c);if(0!=s)return this.createStructure(h,e,u,s+1);e.append(this.createStructure(h,e,u,s+1))},this.displayBibtex=function(t,e){var i=new BibtexParser;i.setInput(t),i.bibtex();var s=i.getEntries(),r=e.find("*"),n=$(".bibtex_structure").clone();if(n.length){var a=this.createArray(s);this.createStructure(n,e,a)}else for(var h in s){var o=s[h];tpl=this.createTemplate(o,e),tpl&&(e.append(tpl),tpl.show())}r.remove()}}function bibtex_js_draw(){if($(".bibtex_template").hide(),$("#bibtex_input").length)(new BibtexDisplay).displayBibtex($("#bibtex_input").val(),$("#bibtex_display"));else{var t="",e=[];$("bibtex").each(function(i,s){var r=$.ajax({url:$(this).attr("src"),dataType:"text"}).done(e=>t+=e).fail((t,e,i)=>console.error(i));e.push(r)}),$.when.apply($,e).then(function(){$("#bibtex_display").length?(new BibtexDisplay).displayBibtex(t,$("#bibtex_display")):$(".bibtex_display").length&&$(".bibtex_display").each(function(e){(new BibtexDisplay).displayBibtex(t,$(this))}),loadExtras(),$(".bibtex_structure").remove()})}}function BibTeXSearcher(){this.inputArray=new Array(""),this.inputLength=0,this.setInputArray=function(t){this.inputArray=t,this.inputLength=t.length},this.getStringName=function(t){var e=t.indexOf("@")+1,i=t.indexOf("[",e),s=[];return-1==i?s[0]=t.substring(e,t.length):(s[0]=t.substring(e,i),end_pos2=t.indexOf("]",e),s[1]=t.substring(i+1,end_pos2)),s},this.checkEntry=function(t,e){var i=!1;if("@"!=e[0])t.find("span:not(.noread)").each(function(){if($(this).text().search(new RegExp(e,"i"))>-1&&t.is(":visible"))return i=!0,!1});else{var s=e.split("="),r=this.getStringName(s[0]);if(r.length<2)t.find("span:not(.noread)."+r[0]).each(function(){if($(this).text().search(new RegExp(s[1],"i"))>-1&&t.is(":visible"))return i=!0,!1});else switch(r[1]){case"first":t.find("span:not(.noread)."+r[0]).each(function(){if(arrayString=$(this).text().split(new RegExp(",[\\s]+and[\\s]+|,[\\s]+")),s[1]==arrayString[0]&&t.is(":visible"))return i=!0,!1})}}return i},this.unhideAll=function(){$("div#bibtex_display, div.bibtex_display").children().each(function(){$(this).show(),$(this).find(".bibtexentry").each(function(){$(this).show()})})},this.hideEntry=function(t){var e=this,i=$("div#bibtex_display, div.bibtex_display").children();i.first().hasClass("bibtexentry")?i.each(function(){e.checkEntry($(this),t)||$(this).hide()}):i.each(function(){var i=!0;$(this).find(".bibtexentry:visible").each(function(){e.checkEntry($(this),t)?i=!1:$(this).hide()}),i&&$(this).hide()})},this.searcher=function(t,e){e=void 0!==e&&e;var i=t;if(i.length){var s=i.split("%");if(this.inputLength>s.length||0==this.inputLength)e=!0;else if(this.inputArray[this.inputArray.length-1].length>s[s.length-1].length)e=!0;else for(var r=0;r<this.inputArray.length-1;r++)if(this.inputArray[r]!=s[r]){e=!0;break}if(e)for(var n in this.unhideAll(),s)this.hideEntry(s[n]);else this.hideEntry(s[s.length-1]);this.setInputArray(s)}else this.unhideAll()}}function createWebPage(t){$(document).ready(function(){0==$(".bibtex_template").length&&$("body").append(t),bibtex_js_draw()})}function loadExtras(){BibTeXSearcherClass=new BibTeXSearcher,$(".bibtex_author").each(function(t,e){authorList($(this))}),localStorage.removeItem("customerDatabase"),localStorage.searcher||(localStorage.searcher=new Object),$("select").each(function(){localStorage.getItem($(this).attr("id"))&&$(this).val(JSON.parse(localStorage.getItem($(this).attr("id"))))}),$(".bibtex_search").each(function(t,e){$(this).on("change",function(t){combineSearcher(BibTeXSearcherClass,!0),localStorage.setItem($(this).attr("id"),JSON.stringify($(this).val()))}),$(this).keyup(function(){combineSearcher(BibTeXSearcherClass)}),""!=$(this).val()&&combineSearcher(BibTeXSearcherClass,!0)})}function combineSearcher(t,e){e=void 0!==e&&e;var i="";$("select.bibtex_search").each(function(t,e){var s="";e.hasAttribute("search")&&(s="@"+$(this).attr("search")),e.hasAttribute("extra")?s+="["+$(this).attr("extra")+"]=":""!=s&&(s+="="),""!=$(this).val()&&(i+="%"+s+$(this).val())}),$("input.bibtex_search").each(function(t,e){""!=$(this).val()&&(i+="%"+$(this).val().split(" ").join("%"))}),t.searcher(i,e)}function authorList(t){var e=new Object;$("span.author").each(function(i,s){if(arrayString=$(this).text().split(new RegExp(",[\\s]+and[\\s]+|,[\\s]+")),"first"==t.attr("extra"))e[arrayString[0]]=1;else for(i=0;i<arrayString.length;i++)arrayString[i]in e?e[arrayString[i]]+=1:e[arrayString[i]]=1});var i=[];for(var s in e)i.push([s,s.split(" ").pop().toLowerCase()]);i.sort(function(t,e){return(t=t[1])<(e=e[1])?-1:t>e?1:0});for(var r=0;r<i.length;r++){s=i[r][0],i[r][1];var n=s.split(" "),a=n.pop()+", "+n.join(" ");t.append($("<option></option>").attr("value",s).text(a))}}var defaultTemplate='<div class="bibtex_template"><div class="if author" style="font-weight: bold;">\n<span class="if year">\n<span class="year"></span>,\n</span>\n  <span class="author"></span>\n<span class="if url" style="margin-left: 20px">\n<a class="url" style="color:black; font-size:10px">(view online)</a>\n</span>\n</div>\n<div style="margin-left: 10px; margin-bottom:5px;">\n<span class="title"></span>\n</div></div>';if(window.jQuery&&window.moment)createWebPage(defaultTemplate);else{if(!window.jQuery){var jq=document.createElement("script");jq.type="text/javascript",jq.src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js",document.getElementsByTagName("head")[0].appendChild(jq)}if(!window.moment){var mo=document.createElement("script");mo.type="text/javascript",mo.src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js",document.getElementsByTagName("head")[0].appendChild(mo)}var checkReady=function(t){window.jQuery&&window.moment?t(jQuery&&moment):window.setTimeout(function(){checkReady(t)},100)};checkReady(function(t){createWebPage(defaultTemplate)})}
